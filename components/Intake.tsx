                ...
                >
                  ...
                  <div className="mt-2 flex items-center gap-4">
                    <button
                      ...
                      className="rounded-sm bg-cta px-6 py-3.5 font-display text-base font-bold text-white transition-[transform,box-shadow,opacity] duration-150 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(46,29,14,0.4)] active:translate-y-0 active:scale-[0.97] disabled:opacity-50"
                    >
                      {status === "sending"
                        ? "Sending..."
